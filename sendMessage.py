...
with open('listOfContacts.txt') as csv_file:
    ...
    for row in csv_reader:
        ...
        # Edit message here
        message = 'Brother {}, Status Report: I still need your transcript. Please send it to me. I also sent this link to your email if that is easier. {}'.format(row[1], row[2])
